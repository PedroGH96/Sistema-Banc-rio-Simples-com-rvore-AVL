...
public class BancoServico implements IOperacoesBancarias {
    ...
    public void removerCliente(String cpf) throws ClienteNaoEncontradoException {
        ...
        // 1. Remover todas as contas do cliente
        List<Conta> contasDoCliente = repositorioContas.listarContasPorCliente(cliente);
        for (Conta conta : contasDoCliente) {
            repositorioContas.remover(conta.getNumero());
        }

        // 2. Remover o cliente do repositório AVL
    ...
    @Override
    public IRepositorioClientes getRepositorioClientes() {
