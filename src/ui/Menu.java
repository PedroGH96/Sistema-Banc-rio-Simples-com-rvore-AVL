...
public class Menu {
    ...
    private void removerCliente() {
        ...
        try {
            ...
            operacoesBancarias.removerCliente(cpf);
            System.out.println("Cliente e todas as suas contas removidas com sucesso!");
    ...
    private void visualizarAVL() {
        System.out.println("\n=== VISUALIZAÇÃO DA ÁRVORE AVL (CLIENTES) ===");
        
        // Acessando o repositório para obter a visualização da árvore
        if (operacoesBancarias.getRepositorioClientes() instanceof repository.RepositorioClientes) {
            repository.RepositorioClientes repo = (repository.RepositorioClientes) operacoesBancarias.getRepositorioClientes();
            System.out.println(repo.getAVLView());
        } else {
            System.out.println("Erro: Repositório de clientes não é do tipo esperado para visualização da AVL.");
        }
    }
